...
def main(args, config, Data):
    ...
    Meta = MAML(args, config, Data).to(device)
    ...
    valid_pool, test_pool = downstream_task_generator(args, Data, args.n_way, args.k_shot)
...
if __name__ == '__main__':
    ...
    # Applying graph Diffusion; Not needed in Supervised settings
    ...
    results = open(f'./results/{args.dataset}/{args.setting}.txt', 'a')
    results.write('\n====================================================================================================\n')
